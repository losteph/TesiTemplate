...
Ho aggiunto una versione italiana ed una inglese. \'E presente il file ```.gitignore``` perché da locale, a differenza se si usa overleaf,
verranno prodotti una serie di file superflui necessari solo alla compilazione.
